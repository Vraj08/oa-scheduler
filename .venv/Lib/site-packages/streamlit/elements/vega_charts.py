...
class VegaChartsMixin:
    ...
    def line_chart(
        ...
        *,
        ...
        width : int or None
            ...
            To use ``width``, you must set ``width='content``.
        ...
        width : bool
            ...
            container. If ``width`` is ``True`` (default),
            Streamlit sets the width of the chart to match the width of the
            parent container. If ``width`` is ``False``,
    ...
    def _vega_lite_chart(
        ...
        **kwargs: Any,
        ...
        spec = _prepare_vega_lite_spec(spec, width, **kwargs)
