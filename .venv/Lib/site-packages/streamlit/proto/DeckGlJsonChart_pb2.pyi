...
class DeckGlJsonChart(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["form_id", b"form_id", "height", b"height", "id", b"id", "json", b"json", "mapbox_token", b"mapbox_token", "selection_mode", b"selection_mode", "tooltip", b"tooltip", "width", b"width", "width", b"width"]) -> None: ...
