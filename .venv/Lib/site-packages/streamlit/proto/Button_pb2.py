...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BUTTON'].fields_by_name['width']._loaded_options = None
  _globals['_BUTTON'].fields_by_name['width']._serialized_options = b'\030\001'
